...
const firebaseConfig = {
  ...
  firestoreDatabaseId: import.meta.env.VITE_FIREBASE_DATABASE_ID || localConfig.firestoreDatabaseId || "ai-studio-harmonifinansial-3841d967-f381-4803-b6e7-b0b4fcdc5ca8",
